...
function loadCalendar() {
    ...
    fetch(`/company/calendar/data?mode=week&date=${dateStr}&staff_id=${staffId}`)
        ...
        .then(data => {
            ...
            html += '<table class="w-full text-sm border-separate border-spacing-0">';
            html += '<thead><tr>';
            html += '<th class="p-4 bg-gray-50 sticky left-0 z-10 text-left">時間</th>';
            ...
            times.forEach(time => {
                ...
                html += `
                    <tr class="hover:bg-gray-50 transition">
                        <td class="p-4 font-medium bg-gray-50 sticky left-0">
                            ${time}
                        </td>`;
