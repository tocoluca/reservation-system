...
<div class="mb-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <a href="{{ route('company.calendar') }}"
           class="bg-white shadow hover:shadow-lg transition rounded-xl p-6 border-l-4 border-blue-500">
            ...
            <div class="text-blue-500 text-sm font-semibold mb-2">
                RESERVATION
            </div>
        ...
        <a href="{{ route('company.staff.index') }}"
           class="bg-white shadow hover:shadow-lg transition rounded-xl p-6 border-l-4 border-indigo-500">
            ...
            <div class="text-indigo-500 text-sm font-semibold mb-2">
                STAFF
            </div>
        ...
        <a href="{{ route('company.vacation.index') }}"
           class="bg-white shadow hover:shadow-lg transition rounded-xl p-6 border-l-4 border-green-500">
            ...
            <div class="text-green-500 text-sm font-semibold mb-2">
                VACATION
            </div>
        ...
        <a href="{{ route('company.theme') }}"
           class="bg-white shadow hover:shadow-lg transition rounded-xl p-6 border-l-4 border-purple-500">

            <div class="text-purple-500 text-sm font-semibold mb-2">
                DESIGN
            </div>
	...
	<a href="{{ route('company.info.edit') }}"
	   class="bg-white shadow hover:shadow-lg transition rounded-xl p-6 border-l-4 border-orange-500">

	    <div class="text-orange-500 text-sm font-semibold mb-2">
	        COMPANY
	    </div>
	...
	@endif
        ...
        <a href="{{ route('company.logo') }}"
           class="bg-white shadow hover:shadow-lg transition rounded-xl p-6 border-l-4 border-gray-500">
    ...
    <div class="bg-white shadow rounded-xl p-6 mb-10">
        ...
        <h2 class="font-bold mb-4">予約テスト（開発用）</h2>
