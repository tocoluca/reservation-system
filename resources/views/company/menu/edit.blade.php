    ...
    <div class="relative overflow-hidden rounded-3xl shadow-lg">
        ...
        <div class="relative px-6 sm:px-8 py-7 sm:py-8 text-white"
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
                <div>
                    <p class="text-xs sm:text-sm tracking-widest uppercase opacity-80">Edit Menu</p>
                    <h1 class="text-2xl sm:text-3xl font-bold mt-1">メニュー編集</h1>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <form method="POST"
            ...
            <div class="px-6 py-4 border-b border-gray-100"
                ...
                <p class="text-sm text-gray-500 mt-1">内容を確認しながら更新してください。</p>
            </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea
                        name="description"
                        rows="5"
                        class="border border-stone-300 rounded-2xl px-4 py-3 w-full">{{ $menu->description }}</textarea>
                </div>
