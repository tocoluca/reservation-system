    ...
    <tr>
        <td align="center">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #eadfd3;">
                <tr>
                    <td style="background:linear-gradient(135deg,#c8a07d,#a87555);padding:24px 32px 28px;color:#ffffff;text-align:center;">
                        <div style="font-size:12px;letter-spacing:.12em;font-weight:bold;opacity:.9;">CONFIRMATION REMINDER</div>
                        <h1 style="margin:10px 0 0;font-size:26px;line-height:1.4;font-weight:bold;">ご確認のお願い</h1>
                        <p style="margin:10px 0 0;font-size:14px;line-height:1.8;opacity:.95;">
                            先日ご案内したご予約変更につきまして、再度ご連絡しております。
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:32px;">
                        ...
                        <div style="margin:0 0 24px;padding:20px;background:#fffaf5;border:1px solid #f0e2d4;border-radius:16px;">
                            <div style="font-size:14px;font-weight:bold;margin-bottom:10px;color:#8c5f43;">内容確認はこちら</div>
                            ...
                            <div style="text-align:center;margin:18px 0;">
                                <a href="{{ $confirmUrl }}" style="display:inline-block;background:#a87555;color:#ffffff;text-decoration:none;font-size:14px;font-weight:bold;padding:14px 28px;border-radius:999px;">
                                    内容を確認する
                                </a>
                            </div>
